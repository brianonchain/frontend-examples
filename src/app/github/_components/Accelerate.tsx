...
export default function Accelerate() {
  ...
  return (
    <div className="mt-[80px] w-full flex flex-col items-center">
      ...
      <p className="px-[24px] mt-4 text-slate-300 text-2xl font-semibold text-center max-w-210">
      ...
      <div className="mt-[80px] w-full lg:mx-[32px] max-w-[1280px]">
        <div className="px-[24px] py-[40px] w-full h-[550px] flex justify-center items-center bg-[#7769D1]/12 border-t lg:border-r lg:border-l border-slate-500 lg:rounded-t-3xl relative">
          {/*--- radial gradient ---*/}
      ...
      <div className="w-full flex flex-col items-center border-t border-slate-600">
        <div className="w-full lg:mx-[32px] max-w-[1280px] grid grid-cols-1 lg:grid-cols-[2fr_1fr] border-slate-600 text-slate-500">
          <div className="row-span-2 p-6 xs:p-12 flex flex-col gap-4 lg:border-l lg:border-b lg:border-r border-slate-600 text-2xl font-bold">
            <p>
          ...
          <div className="p-6 xs:p-12 lg:border-r border-t border-b border-slate-600 text-2xl font-bold">
            <p>Duolingo boosts developer speed by 25% with GitHub Copilot</p>
            <AnimatedLink title="Read customer story" />
          </div>
          <div className="p-6 xs:p-12 lg:border-r border-b border-slate-600 text-2xl font-bold">
      ...
      <div className="w-full flex flex-col items-center border-t border-b border-slate-600">
        <div className="w-full lg:mx-[32px] max-w-[1280px] flex flex-col-reverse lg:flex-row text-slate-500">
          {/*--- left cell ---*/}
          <div className="px-6 xs:px-12 py-6 lg:border-l lg:border-r border-slate-600">
          ...
          {/*--- right cell ---*/}
          <div className="px-6 py-12 w-full flex justify-center items-center border-b lg:border-b-0 lg:border-r border-slate-600 bg-white/5 relative overflow-hidden">
            {/*--- radial gradient ---*/}
